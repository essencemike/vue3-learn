...
files.forEach(shortName => {
  ...
  if (args.force || !pkgExists) {
    const json = {
      ...
      repository: {
        type: 'git',
        url: 'git+https://github.com/essencemike/vue3-learn.git'
      },
      keywords: ['vue3'],
      author: 'IMike',
      license: 'MIT',
      bugs: {
        url: 'https://github.com/essencemike/vue3-learn/issues'
      },
      homepage: `https://github.com/essencemike/vue3-learn/tree/master/packages/${shortName}#readme`
    }
